- stage: SetPipelineVariablePython
  displayName: 'Set Release Pipeline Variable via Python'
  jobs:
  - job: SetVariablePythonJob
    displayName: 'Set Variable Job (Python)'
    pool:
    ...
    - script: |
      ...
      env:
        ...
        PREDEPLOYGATE_SN_CHANGE_REQUEST_NUMBER: $(PREDEPLOYGATE.SN.CHANGE_REQUEST_NUMBER)
